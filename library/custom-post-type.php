...
function custom_post_example() { 
    ...
    */
    ...
    function ceekay_hero_thumb() { 
	// creating (registering) the custom type 
	register_post_type( 'hero_thumb', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Hero Thumbs', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Hero Thumb', 'bonestheme'), /* This is the individual type */
			'all_items' => __('All Hero Thumbs', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Add New', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Add New Hero Thumb', 'bonestheme'), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __('Edit Hero Thumbs', 'bonestheme'), /* Edit Display Title */
			'new_item' => __('New Hero Thumb', 'bonestheme'), /* New Display Title */
			'view_item' => __('View Hero Thumb', 'bonestheme'), /* View Display Title */
			'search_items' => __('Search Hero Thumb', 'bonestheme'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.', 'bonestheme'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash', 'bonestheme'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Hero Thumbnails for the Startpage', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_position' => 8, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-icon.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'hero_thumb', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'hero_thumb', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
	...
	/* this adds your post categories to your custom post type */
	register_taxonomy_for_object_type('category', 'hero_thumb');
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'hero_thumb');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'ceekay_hero_thumb');	
